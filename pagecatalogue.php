...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="#">Browse by serial no.</a></li>
</ul>

<div class="sub-hero-unit">
<p>Our very first three releases (in 2002) were assigned numbers 001-003, since when we have produced and issued three CDs every month and will soon reach number 500!</p>
<?php
$x=50;
$offset = 0;
if(isset($_GET['part'])) 
